        ...
        <div class=" main-wraper" id="product">
            <div uk-filter="target: .js-filter">
                {{-- <ul class="uk-subnav uk-subnav-pill">
                    ...
                    <li uk-filter-control="[data-color='phones']"><a
                            href="#">Phones</a></li>
                    <li uk-filter-control="[data-color='accessories']"><a
                            href="#">Accessories</a></li>
                    <li uk-filter-control="[data-color='repairs']"><a
                            href="#">Repairs</a></li>
                    <li uk-filter-control="[data-color='spare-parts']"><a
                            href="#">Spare Parts</a></li>
                </ul> --}}
                ...
                <div class="row js-filter uk-child-width-1-2 uk-child-width-1-3@m">
                    ...
                    @livewire('usermodule::user.user-header-information', ['user' => $product->user , 'product' => $product ])
                    ...
                    <span id="product-name"><a href="{{ route('show.product', ['product'=>$product]) }}" title="">{{$product->name}}</a></span>
