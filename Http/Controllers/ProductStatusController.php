...
use Modules\Product\Services\ProductStatusService;
...
public function index()
{
    ...
    return view('product::dashboard.productStatus.index',compact('statuses'));
}
...
{
    return view('product::dashboard.productStatus.create');
}
...
public function edit($id)
{
    ...
    return view('product::dashboard.productStatus.edit',compact('status'));
}
